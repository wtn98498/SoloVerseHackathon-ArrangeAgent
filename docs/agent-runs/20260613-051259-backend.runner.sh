#!/usr/bin/env bash
set +e
cd "/Users/scala/Documents/soloverseAgent/.worktrees/backend" || exit 1
prompt_text="$(cat "/Users/scala/Documents/soloverseAgent/docs/agent-runs/backend.prompt.txt")"
{
  ...
  exit "$status"
} > "/Users/scala/Documents/soloverseAgent/docs/agent-runs/20260613-051259-backend.log" 2>&1
