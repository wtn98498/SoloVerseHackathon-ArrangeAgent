...
- 想玩音乐，但不懂乐理的人。
- 能说出“我想要开心、松弛、古风、热血”，但不知道怎么写和弦、鼓点、贝斯的人。
- 被 GarageBand、Logic、Ableton、FL Studio 这类工具吓退的人。

产品文案尽量不用专业术语。优先使用“更明亮”“更有劲”“更柔和”“变古风”“加点律动”这类自然语言。
...
- 古风 / Chinese style / gufeng

古风不要做成一整套复杂民族乐器系统，而是做成风格转换层：

- 吉他轨可以被古筝 / 琵琶感 pluck 替换或点缀。
- 电子琴旋律可以被笛子 / 二胡感 lead 替换或点缀。
- 鼓轨可以加中国打击乐点缀。
- 旋律优先使用五声音阶材料。
...
1. 用户选择一个风格，例如 Pop、Lo-fi、Rock、古风。
2. 用户选择一个乐器轨道。
3. 用户用大按钮玩 5-10 秒。
...
- 中国打击乐点缀采样。
- 古筝 / 琵琶感 pluck 采样或 synth preset。
- 笛子 / 二胡感 lead 采样或 synth preset。
- 合成贝斯 preset。
- 电子琴 / pad preset。

为了压缩两天周期，优先用 Tone.js synth 解决贝斯、电子琴和部分 pluck。只有鼓和古风点缀这类“声音特征很明显”的地方再用短采样。
